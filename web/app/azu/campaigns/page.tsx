              ...
              >
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <span
                      className="text-sm opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-[opacity,transform] duration-300 ease-out flex-shrink-0 inline-block mt-1"
                      style={{ color: "var(--accent-gold)" }}
                    >
                      →
                    </span>
