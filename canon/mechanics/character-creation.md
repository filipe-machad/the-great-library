...
related:
  ...
  - TGL-MEC-0002
  - TGL-AZU-0002
summary: "Guia de criação de personagem: escolha de traço, definição de limites e visão geral do mundo para jogadores."
sources: []
category: "núcleo"
impact: ["criação de personagem"]
---

# Criação de Personagem

## Passo 1 — Escolha seu Traço
...
Defina um limite: um medo, uma linha que você não cruza.

> **Importante:** É sempre amplificação daquilo que o personagem **JÁ É**. O artefato não cria, não desperta, não concede — **amplifica**.

---

## Amplificação

Quando seu personagem utiliza um orbe ou artefato, o traço central é amplificado. A manifestação depende do traço escolhido e do tipo/nível do artefato.

Consulte [Traços de Personalidade e Amplificações](personality-traits.md) para os efeitos específicos de cada traço.
