---
id: TGL-MEC-0004
title: "Artesãos — Os Tecelões da Azü"
type: mechanic
status: canon
visibility: public
version: 1.0.0
...
related:
  - TGL-NPC-0001
  - TGL-AZU-0002
summary: "O ofício dos artesãos: coleta, purificação e tecelagem da azü, mais as Sete Leis da Moldagem."
sources: []
category: "núcleo"
impact: ["ambientação", "economia", "criação de artefatos"]
---

# Artesãos — Os Tecelões da Azü
...
1. **Coleta** — Coletam azü em lugares propícios (sem "raspar" o local).
2. **Purificação** — Decantam resíduos espirituais.
3. **Tecelagem** — Tecem a energia em nós dentro de recipientes e objetos.
...
- [Origens Mitológicas dos Artesãos](../npcs/artisan-master.md)
